...
/*   Updated: 2022/03/07 15:41:39 by sshakya          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
namespace _test
{
    ...
    rdm_val<std::pair<int, std::string> >()
    {
        return std::pair<int, std::string>(rdm_val<int>(), rdm_val<std::string>());
    }
    
    template <>
    ft::pair<int, std::string>
    rdm_val<ft::pair<int, std::string> >()
    {
        return ft::pair<int, std::string>(rdm_val<int>(), rdm_val<std::string>());
    }
}
